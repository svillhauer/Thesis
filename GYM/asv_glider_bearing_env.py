...
class AsvGliderBearingEnv(gym.Env):
    ...
    def __init__(self):
        ...
        obs_max = np.array([np.pi, 2.0, 2.0, self.world_size, self.world_size], dtype=np.float32)
    ...
    def _get_obs(self):
        ...
        # include ASV GPS position to match thesis
        obs = np.array([
            bearing,
            current[0],
            current[1],
...
if __name__ == "__main__":
    ...
    for step in range(20):
        # random action just to see things move
